...
defineProperty("torq", globalProperty("sim/cockpit2/engine/indicators/torque_n_mtr[0]"))
defineProperty("ikm") -- flight time

-- images
defineProperty("needleImage", langImage("needles", 1, 168, 16, 88))
defineProperty("black_cap", langImage("covers", 344, 36, 56, 92)) -- black cap image
...
function update()
    ...
    if v < 20 and v > 8 then
        v = v + math.random(-10, 10)
    elseif v < 8 then
        v = 0
    end
