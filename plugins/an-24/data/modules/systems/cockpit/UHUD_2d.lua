...
defineProperty("overlay", sasl.gl.loadImage("UHUD.dds", 0, 207, 205, 305))
defineProperty("black", sasl.gl.loadImage("UHUD.dds", 5, 7, 5, 5))
defineProperty("digitsImage", sasl.gl.loadImage("UPhone.dds", 493, 232, 14, 280))
defineProperty("tape", sasl.gl.loadImage("UHUD.dds", 241, 0, 128, 512))
defineProperty("compass", sasl.gl.loadImage("UHUD.dds", 370, 106, 128, 128))
defineProperty("search", sasl.gl.loadImage("UHUD.dds", 0, 0, 205, 125))
defineProperty("warning", sasl.gl.loadImage("UHUD.dds", 0, 127, 205, 78))
defineProperty("understood", sasl.gl.loadImage("UHUD.dds", 381, 58, 107, 21))
...
defineProperty("altitude", globalProperty("sim/flightmodel/position/elevation"))
defineProperty("heading", globalProperty("sim/flightmodel/position/hpath"))
defineProperty("vert", globalProperty("sim/flightmodel/position/vh_ind_fpm"))
