...
local bg = sasl.gl.loadImage("images/UMETAR.dds", 0, 207, 205, 305)
local font = sasl.gl.loadBitmapFont("fonts/UPhone.fnt")
...
function readmetar()
    ...
    -- if file exists - read it and fill the variables with new values
    if file then
        METAR1 = input
        METAR2 = "NOT FOUND"
        METAR3 = ""
        ...
        print("METAR.rwx couldn't be read")
...
function draw()
    ...
    sasl.gl.drawBitmapText(font, 10, 264, METAR1, TEXT_ALIGN_LEFT)
    sasl.gl.drawBitmapText(font, 10, 237, METAR2, TEXT_ALIGN_LEFT)
    sasl.gl.drawBitmapText(font, 10, 210, METAR3, TEXT_ALIGN_LEFT)
    sasl.gl.drawBitmapText(font, 10, 183, METAR4, TEXT_ALIGN_LEFT)
    sasl.gl.drawBitmapText(font, 10, 156, METAR5, TEXT_ALIGN_LEFT)
    sasl.gl.drawBitmapText(font, 10, 129, METAR6, TEXT_ALIGN_LEFT)

    sasl.gl.drawBitmapText(font, 10, 92, input, TEXT_ALIGN_LEFT)
end
