...
defineProperty("adf1", globalProperty("sim/cockpit2/radios/actuators/adf1_frequency_hz"))
defineProperty("adf2", globalProperty("sim/cockpit2/radios/actuators/adf2_frequency_hz"))

defineProperty("nav1", globalProperty("sim/cockpit2/radios/actuators/nav1_frequency_hz")) -- set the frequency
defineProperty("nav2", globalProperty("sim/cockpit2/radios/actuators/nav2_frequency_hz")) -- set the frequency
defineProperty("obs1", globalProperty("sim/cockpit2/radios/actuators/nav1_obs_deg_mag_pilot")) -- set the course
defineProperty("obs2", globalProperty("sim/cockpit2/radios/actuators/nav2_obs_deg_mag_pilot")) -- set the course
...
defineProperty("dme", globalProperty("sim/cockpit2/radios/actuators/dme_frequency_hz")) -- set the frequency
...
defineProperty("baro1", globalProperty("sim/cockpit2/gauges/actuators/barometer_setting_in_hg_pilot"))
defineProperty("baro2", globalProperty("sim/cockpit2/gauges/actuators/barometer_setting_in_hg_copilot"))

defineProperty("distance", globalProperty("sim/cockpit2/radios/indicators/dme_dme_distance_nm")) -- distance in NM

-- images
defineProperty("background", sasl.gl.loadImage("info_panel.dds", 0, 0, size[1], size[2]))
defineProperty("digitsImage", sasl.gl.loadImage("black_digit_strip.png", 1, 60, 14, 196))
defineProperty("from_img", sasl.gl.loadImage("info_panel.dds", 227, 244, 29, 12))
defineProperty("to_img", sasl.gl.loadImage("info_panel.dds", 227, 232, 29, 12))
defineProperty("none_img", sasl.gl.loadImage("info_panel.dds", 228, 240, 1, 1))
...
function update()
    ...
    if get(obs1_fromto_lit) == 1 then
        obs1_fromto_img = get(to_img)
    elseif get(obs1_fromto_lit) == 2 then
        obs1_fromto_img = get(from_img)
    else
        obs1_fromto_img = get(none_img)
    end

    if get(obs2_fromto_lit) == 1 then
        obs2_fromto_img = get(to_img)
    elseif get(obs2_fromto_lit) == 2 then
        obs2_fromto_img = get(from_img)
    else
        obs2_fromto_img = get(none_img)
    end
