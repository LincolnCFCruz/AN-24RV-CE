...
defineProperty("wind_ht_sw2", globalProperty("an-24/ice/window_ht_sw2")) -- window heat copilot
...
defineProperty("lat_rotary_img", sasl.gl.loadImage("right_panel_2d_e.dds", 856, 406, 98, 98))
...
defineProperty("prop_up_img", sasl.gl.loadImage("right_panel_2d_e.dds", 831, 329, 66, 66))
defineProperty("prop_ctr_img", sasl.gl.loadImage("right_panel_2d_e.dds", 831, 258, 66, 66))
defineProperty("prop_dn_img", sasl.gl.loadImage("right_panel_2d_e.dds", 831, 187, 66, 66))
...
components = { 
    -- background
    texture {
        image = langImage("right_panel_2d", 0, 82, size[1], size[2]),
    ...
    texture {
        ...
        image = function()
            ...
            if a == 1 then
                return get(prop_up_img)
            elseif a == -1 then
                return get(prop_dn_img)
            else
                return get(prop_ctr_img)
            end
        end
    }, 
