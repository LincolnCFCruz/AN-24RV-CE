...
defineProperty("bg", sasl.gl.loadImage("UTurn.dds", 0, 207, 205, 305))
defineProperty("digitsImage", sasl.gl.loadImage("UPhone.dds", 473, 232, 14, 280))
...
function update()
    ...
    if diff == 180 or diff == -180 then
        ...
        start = ((TAS / 3.6) ^ 2 / (9.81 * math.tan(bank * math.pi / 180))) *
