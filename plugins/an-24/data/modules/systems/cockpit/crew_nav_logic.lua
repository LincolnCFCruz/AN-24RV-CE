...
defineProperty("radioalt_dh", globalProperty("an-24/gauges/radioalt_dh")) -- radio altitude is decision height
    ...
    if speech_timer == 0 and not external and not cpl_active then -- here goes speech logic
        ...
        elseif v_spd < 0 and ruds < 1.4 then
            if r_alt > 595 and r_alt < 605 and not alt_600_was then -- alt 600
                sasl.al.playSample(alt_600, false)
                speech_timer = 2
                alt_600_was = true
                alt_500_was = false
            elseif r_alt > 495 and r_alt < 505 and not alt_500_was then -- alt 500
                sasl.al.playSample(alt_500, false)
                speech_timer = 2
                alt_600_was = false
                alt_500_was = true
                alt_400_was = false
            elseif r_alt > 395 and r_alt < 405 and not alt_400_was then -- alt 400
                sasl.al.playSample(alt_400, false)
                speech_timer = 1
                alt_500_was = false
                alt_400_was = true
                alt_300_was = false
            elseif r_alt > 295 and r_alt < 305 and not alt_300_was then -- alt 300
                sasl.al.playSample(alt_300, false)
                speech_timer = 1
                alt_400_was = false
                alt_300_was = true
                alt_200_was = false
            elseif r_alt > 195 and r_alt < 205 and not alt_200_was then -- alt 200
                sasl.al.playSample(alt_200, false)
                speech_timer = 1
                alt_300_was = false
                alt_200_was = true
                alt_100_was = false
            elseif get(radioalt_dh) == 1 and not rating_was and not (gear_defl > 0.2 and gear_dep > 2.9 and v_ias < 40) then -- decision callout
                sasl.al.playSample(rating, false)
                speech_timer = 1
                rating_was = true
