...
defineProperty("altitude", globalProperty("sim/cockpit2/gauges/indicators/altitude_ft_copilot"))
...
-- electric
defineProperty("uvid_30_cc", globalProperty("an-24/gauges/uvid_30_cc")) -- gauge current consumption
defineProperty("uvid_30_sw", globalProperty("an-24/gauges/uvid_30_sw")) -- gauge switcher ON/OFF
...
-- pressure value
defineProperty("pressure", globalProperty("sim/cockpit2/gauges/actuators/barometer_setting_in_hg_copilot"))
...
-- red led image
defineProperty("red_led", loadLED("red_small"))
...
function update()
    ...
    -- gauge logic
    if power_27 * power_115 * switcher > 0 and fail < 6 then -- altitude in meters. works only when power exists
