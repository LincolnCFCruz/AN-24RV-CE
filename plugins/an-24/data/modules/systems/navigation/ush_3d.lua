...
defineProperty("ushdb_3_scale_angle", globalProperty("an-24/misc/ushdb_3_scale_angle")) -- scale rotation angle (integrated by navigator_logic.lua)
defineProperty("ushdb_3_scale_dir", globalProperty("an-24/misc/ushdb_3_scale_dir")) -- scale rotation direction (set by this panel's knobs)
