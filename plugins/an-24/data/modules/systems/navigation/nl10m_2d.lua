...
local lang = 0
local change_side_img = sasl.gl.loadImage("fuel_panel_2d_e.dds", 0, 1, 132, 23)
local ruler1 = langImages("nl10m", 0, 724, 2048, 300)
local ruler2 = langImages("nl10m", 0, 428, 2048, 300)
local slider1 = langImages("nl10m", 0, 241, 2048, 145)
local slider2 = langImages("nl10m", 0, 73, 2048, 145)
...
function update()
    ...
    if X_scroll_bkg > MAX then
        X_scroll_bkg = MAX
    end
    if X_scroll_bkg < MIN then
        X_scroll_bkg = MIN
    end
    ...
    if X_scroll_bkg == MAX and drag_bkg then
        X_scroll_slider = last_slider + MAX - last_bkg
    elseif X_scroll_bkg == MIN and drag_bkg then
        X_scroll_slider = last_slider - last_bkg
    end

    click_X_slider = move_X_slider

    if X_scroll_slider > MAX2 then
        X_scroll_slider = MAX2
    end
    if X_scroll_slider < MIN2 then
        X_scroll_slider = MIN2
    end
    ...
    if X_scroll_vis > size[1] - 100 then
        X_scroll_vis = size[1] - 100
    end
    if X_scroll_vis < 0 then
        X_scroll_vis = 0
    end
