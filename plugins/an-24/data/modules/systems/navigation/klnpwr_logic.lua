...
local avail = gPi(pfx .. "power/available") -- created in glbl_drfs.lua
...
function update()
    ...
    setbool(avail,
        gvar.bus_dc27v > 19 or gvar.bus_dc27ve > 19 or gvar.bus_ac36v > 35 or gvar.bus_ac115v > 110 or
            get(ground_available) == 1)
end
