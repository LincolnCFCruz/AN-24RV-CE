...
-- ushdb_1_scale_angle, ushdb_1_scale_dir declared in glbl_drfs.lua (runs once); bind below
...
-- images
defineProperty("needle1", langImage("needles", 464, 4, 23, 237))
defineProperty("needle2", langImage("needles", 489, 4, 23, 237))
...
components = { 
	...
	-- scale rotary
	clickable {
		position = {349, 350, 25, 50}, -- find and set correct position
	...
	clickable {
		position = {374, 350, 25, 50}, -- find and set correct position
