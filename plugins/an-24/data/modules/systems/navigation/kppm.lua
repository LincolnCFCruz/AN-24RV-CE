...
-- source
defineProperty("gyro_curse", globalProperty("an-24/gauges/GIK_curse")) -- gyro heading from GIK
...
defineProperty("hor_def", globalProperty("an-24/gauges/curs_1"))
defineProperty("vert_def", globalProperty("an-24/gauges/glide_1"))
defineProperty("curs_flag", globalProperty("an-24/gauges/k1_flag"))
defineProperty("glide_flag", globalProperty("an-24/gauges/g1_flag"))
defineProperty("SC_master", globalProperty("scp/api/ismaster")) -- status of SmartCopilot
defineProperty("scale_angle1_smartcopilot", globalProperty("an-24/gauges/scale_angle_1_smartcopilot")) -- dataref for SmartCopilot synchronisation
defineProperty("scale_angle2_smartcopilot", globalProperty("an-24/gauges/scale_angle_2_smartcopilot")) -- dataref for SmartCopilot synchronisation
defineProperty("rotate_dir1_smartcopilot", globalProperty("an-24/gauges/rotate_dir1_smartcopilot")) -- dataref for SmartCopilot synchronisation
defineProperty("rotate_dir2_smartcopilot", globalProperty("an-24/gauges/rotate_dir2_smartcopilot")) -- dataref for SmartCopilot synchronisation
defineProperty("sc_curse_angle", globalProperty("an-24/gauges/sc_KPPM_1_curse_angle")) -- dataref for SmartCopilot synchronisation
-- signals to autopilot
-- defineProperty("ap_curse") -- heading for autopilot
-- images
defineProperty("scale", sasl.gl.loadImage("kppm.dds", -0.5, 59.5, 196, 196))
defineProperty("curse_needle", sasl.gl.loadImage("kppm.dds", 202.5, 72, 22, 172))
defineProperty("scale_triangle", sasl.gl.loadImage("kppm.dds", 30, 10, 13, 23))
defineProperty("v_plank_img", sasl.gl.loadImage("kppm.dds", 200, 146, 2, 110))
defineProperty("h_plank_img", sasl.gl.loadImage("kppm.dds", 0, 54, 110, 2))
defineProperty("flag_img", sasl.gl.loadImage("kppm.dds", 2, 10, 22, 22))
...
--[[
		if get(SC_master) ~= 1 then
			...
			if scale_angle2 > 180 then 
                scale_angle2 = scale_angle2 - 360
			elseif scale_angle2 < -180 then	
                scale_angle2 = scale_angle2 + 360	
            end
			set(scale_angle1_smartcopilot, scale_angle)
			set(scale_angle2_smartcopilot, scale_angle2)
...
--]]
        ...
        -- set limits
--[[
        if curse_plank < -20 then 
            curse_plank = -20
        elseif curse_plank > 20 then 
            curse_plank = 20 
        end
        
        if glide_plank < -20 then 
            glide_plank = -20
        elseif glide_plank > 20 then 
            glide_plank = 20 
        end 
--]]
