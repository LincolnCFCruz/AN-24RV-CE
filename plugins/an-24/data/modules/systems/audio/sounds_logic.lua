...
defineProperty("steward", globalProperty("an-24/push/steward"))
defineProperty("cabin_chair", globalProperty("sim/cockpit2/switches/custom_slider_on[16]")) -- open/close cabin middle chair
...
defineProperty("alt", globalProperty("sim/cockpit2/gauges/indicators/altitude_ft_pilot"))
defineProperty("flightdeckdoor_toggle", globalProperty("an-24/flightdeckdoor_toggle"))
defineProperty("podnos", globalProperty("an-24/misc/podnos"))
...
function button_sound_function(aaa, iii)
    if get(aaa) == 2 then
        if sound_check_button[iii] == 1 then
            sasl.al.playSample(plastic_button_sound, false)
...
function update()
    if get(steward) == 1 then
        ...
        -- sasl.al.playSample(steward1, false)
    end
